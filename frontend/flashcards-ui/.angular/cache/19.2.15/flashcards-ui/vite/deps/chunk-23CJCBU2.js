...
var createMenuController = () => {
  ...
  const _setOpen = (menu, shouldOpen, animated) => __async(null, null, function* () {
    if (isAnimatingSync()) {
      return false;
    }
    if (shouldOpen) {
...
DomController.ɵfac = function DomController_Factory(__ngFactoryType__) {
...
Platform.ɵfac = function Platform_Factory(__ngFactoryType__) {
...
NavController.ɵfac = function NavController_Factory(__ngFactoryType__) {
...
Config.ɵprov = ɵɵdefineInjectable({
  token: Config,
  factory: Config.ɵfac,
  providedIn: "root"
});
...
AngularDelegate.ɵfac = function AngularDelegate_Factory(__ngFactoryType__) {
...
IonPopover.ɵfac = function IonPopover_Factory(__ngFactoryType__) {
...
IonModal.ɵfac = function IonModal_Factory(__ngFactoryType__) {
...
IonRouterOutlet.ɵfac = function IonRouterOutlet_Factory(__ngFactoryType__) {
...
RoutedComponentInputBinder.ɵfac = function RoutedComponentInputBinder_Factory(__ngFactoryType__) {
...
IonBackButton.ɵfac = function IonBackButton_Factory(__ngFactoryType__) {
...
RouterLinkDelegateDirective.ɵfac = function RouterLinkDelegateDirective_Factory(__ngFactoryType__) {
...
RouterLinkWithHrefDelegateDirective.ɵfac = function RouterLinkWithHrefDelegateDirective_Factory(__ngFactoryType__) {
...
IonNav.ɵfac = function IonNav_Factory(__ngFactoryType__) {
...
IonTabs.ɵfac = function IonTabs_Factory(__ngFactoryType__) {
...
@ionic/core/components/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-23CJCBU2.js.map
